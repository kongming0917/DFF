...
try:
    ...
    try:
        ...
        from yolo_brownian_sim.dataset import create_train_val_loaders, load_frames_from_bin
    except ImportError:
        # fallback to original yolo_sim (for backward compatibility)
...
def train_yolo(
    ...
    for epoch in range(num_epochs):
        ...
        # 데이터셋을 학습 모드로 설정 (Brownian motion은 CSV 레이블 사용)
...
if __name__ == "__main__":
    ...
    print("🎯 Brownian Motion DVS 데이터로 YOLO 학습")
    print("=" * 60)
    ...
    train_yolo(
        model_name='yolo_tiny_laser_brownian',
